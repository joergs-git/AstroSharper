...
The toolbar's **Apply ALL Stuff** button (`⇧⌘A`) is the single entry point that does the right thing for whichever section you're in.
...
- **Help → Buy me a coffee ☕️** — direct support link
- **About AstroSharper** (app menu) — version, links, GitHub / App Store / coffee buttons
