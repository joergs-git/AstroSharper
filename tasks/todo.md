...
End-of-2026-05-01 state: display chain fixed; calibration re-validated (bake-γ + SNR); F3 regression harness end-to-end (v1 + v1.1 sharpness + v1.2 FFT bands + v1.3 reference RMSE); E.2 FITS in/out closed; D.1 calibration GUI shipped; B.6 Drizzle full (GUI + AA pre-filter); B.5 proper PSS cascade in place. Priority order from here:
