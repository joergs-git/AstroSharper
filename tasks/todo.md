...
2. **F3 v1.3** — extend the harness with per-pixel RMSE vs the committed AS!3 reference output `TESTIMAGES/biggsky/2026-03-05-0055_5-MPO_Jupiter__lapl6_ap126.png`. v1.2 (FFT bands, shipped) closed the frequency-content axis; RMSE adds the visual-identity axis on top.
...
5. ~~**Output FITS** — closed 2026-05-01 (commit `762c750`).~~
